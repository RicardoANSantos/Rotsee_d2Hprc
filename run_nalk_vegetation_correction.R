...
methods_lines <- c(
  ...
  "",
  "6. KEY CAVEATS",
  "Fractionation endmembers are regionally calibrated (temperate Central Europe) and should",
  "be validated before use elsewhere. The R.A. index can be affected by species-specific wax",
  "production, degradation, transport and aquatic/non-terrestrial inputs (check CPI, Paq).",
  "",
  "7. REFERENCES",
