...
* The fractionation endmembers are calibrated for temperate Central Europe. Validate them before using the script elsewhere.
* The R.A. index is a wax-source proxy. It is not a measure of pollen-based vegetation cover.
* The significance flags are pointwise and exploratory. They are not simultaneous intervals and they do not include chronology uncertainty. Check the residual autocorrelation in `03_diagnostics`.
